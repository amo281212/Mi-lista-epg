...
MAPEO_IDS = {
    ...
    'Canal.Golden.(México).mx': 'Golden.cl',
    'Canal.Golden.Edge.cl': 'GoldenEdge.cl',
    ...
    'Canal.ESPN.2.(Bolivia).ar': 'ESPN2.cl',
...
FUENTE_POR_CANAL = {
    ...
    'GoldenEdge.cl': 'Canal.Golden.Edge.cr',
    ...
    'ESPN5.cl': 'https://epg.lat/files/co.xml.gz',
